...
### Packaging + operator handoff
- Added Windows startup guide and console command reference for local launch.
- Added Windows startup scripts for backend, frontend, and combined launcher flow.
- Added desktop shortcut installer script for the packaged local app.
- Added project log summarizing both the original uploaded NOVA package and the upgrades completed in this chat.
