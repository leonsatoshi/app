...
- Added a compact live activity ticker beneath the status banner using recent wallet/order events.
...
- Added lifecycle notifications when synced open-order status or fill percentage changes.
